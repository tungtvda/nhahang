...
{
   return sanpham_Get("SELECT sanpham.id, danhmuc1.name as danhmuc1_id, danhmuc2.name as danhmuc2_id, sanpham.highlights, sanpham.name, sanpham.name_url, sanpham.code, sanpham.img, sanpham.img1, sanpham.img2, sanpham.price, sanpham.price_sale, sanpham.price_percent, sanpham.start, sanpham.num_like, sanpham.description_short, sanpham.description FROM  sanpham, danhmuc1, danhmuc2 where danhmuc1.id=sanpham.danhmuc1_id and danhmuc2.id=sanpham.danhmuc2_id  ".(($where!='')?(' and '.$where):'')." Order By ".$Order." Limit ".(($CurrentPage-1)*$PageSize)." , ".$PageSize);
}
//
function sanpham_insert($obj)
{
    return exe_query("insert into sanpham (danhmuc1_id,danhmuc2_id,highlights,name,name_url,code,img,img1,img2,price,price_sale,price_percent,start,num_like,description_short,description) values ('$obj->danhmuc1_id','$obj->danhmuc2_id','$obj->highlights','$obj->name','$obj->name_url','$obj->code','$obj->img','$obj->img1','$obj->img2','$obj->price','$obj->price_sale','$obj->price_percent','$obj->start','$obj->num_like','$obj->description_short','$obj->description')",'sanpham');
}
//
