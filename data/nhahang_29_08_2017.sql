...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th8 29, 2017 lúc 12:18 CH
...
--
-- Cấu trúc bảng cho bảng `dangky_email`
--
...
--
-- Đang đổ dữ liệu cho bảng `dangky_email`
--
...
(10, '/nhahang/view/admin/Themes/kcfinder/upload/images/danhmuc/banner-about.jpg', 'Dịch vụ khác', 'Dịch vụ khác', 'Dịch vụ khác', 'Dịch vụ khác'),
(11, '/nhahang/view/admin/Themes/kcfinder/upload/images/danhmuc/banner-about.jpg', 'Đặt tiệc lưu động', 'Đặt tiệc lưu động', 'Đặt tiệc lưu động', 'Đặt tiệc lưu động'),
(12, '/nhahang/view/admin/Themes/kcfinder/upload/images/danhmuc/banner-about.jpg', 'Cung cấp thực phẩm', 'Cung cấp thực phẩm', 'Cung cấp thực phẩm', 'Cung cấp thực phẩm');
...
--
-- AUTO_INCREMENT cho bảng `dangky_email`
--
ALTER TABLE `dangky_email`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
ALTER TABLE `danhmuc1`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT cho bảng `danhmuc2`
--
ALTER TABLE `danhmuc2`
...
--
-- Các ràng buộc cho bảng `danhmuc2`
--
ALTER TABLE `danhmuc2`
