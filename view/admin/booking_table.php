...
function view_booking_table($data)
{
    ...
    $ft->assign('TABLE-NAME','booking_table');
...
function showFrom($form,$ListKey=array())
{
    ...
    $str_from.='<p><label>member</label><input class="text-input small-input" type="text"  name="member" value="'.(($form!=false)?$form->member:'').'" /></p>';
    $str_from.='<p><label>booking_date</label><input class="text-input small-input" type="text"  name="booking_date" value="'.(($form!=false)?$form->booking_date:'').'" /></p>';
    $str_from.='<p><label>booking_time</label><input class="text-input small-input" type="text"  name="booking_time" value="'.(($form!=false)?$form->booking_time:'').'" /></p>';
