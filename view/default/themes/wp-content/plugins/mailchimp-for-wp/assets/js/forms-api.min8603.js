!function () {
    ...
    !function n(t, r, i) {
        ...
        1: [function (e, t, n) {
            "use strict";
            function r(e) {
                var t = "animated" === f.auto_scroll, n = {behavior: t ? "smooth" : "instant"};
                e.element.scrollIntoView(n)
            }

            function i(e, t, n, i) {
                var o = document.body.clientHeight, s = Date.now();
                n && e.setData(i), f.auto_scroll && r(e), window.addEventListener("load", function () {
                    var c = Date.now() - s;
                    f.auto_scroll && c < 800 && document.body.clientHeight != o && r(e), a.trigger("submitted", [e]), n ? a.trigger("error", [e, n]) : (a.trigger("success", [e, i]), a.trigger(t + "d", [e, i]))
                })
            }

            function o(e, t) {
                return function () {
                    var n = this.value.trim(), r = "radio" !== this.getAttribute("type") && "checked" !== this.getAttribute("type") || this.checked, i = r && (n === t || "" === t && n.length > 0);
            ...
            //    var c = e("gator"), a = e("forms/forms.html"), u = window.mc4wp && window.mc4wp.listeners ? window.mc4wp.listeners : [], f = window.mc4wp_forms_config || {}, l = document.querySelectorAll(".mc4wp-form [data-show-if]");
            //    [].forEach.call(l, function (e) {
            //        for (var t = e.getAttribute("data-show-if").split(":"), n = document.querySelectorAll('.mc4wp-form [name="' + t[0] + '"]'), r = t[1] || "", i = o(e, r), s = 0; s < n.length; s++)n[s].addEventListener("change", i), n[s].addEventListener("keyup", i), i.call(n[s])
            //    });
            //    for (var h = 0; h < u.length; h++)a.on(u[h].event, u[h].callback);
            //    if (c(document.body).on("submit", ".mc4wp-form", function (e) {
            //            var t = a.getByElement(e.target || e.srcElement);
            //            a.trigger("submit", [t, e])
            //        }), c(document.body).on("focus", ".mc4wp-form", function (e) {
            //            var t = a.getByElement(e.target || e.srcElement);
            //            t.started || (a.trigger("started", [t, e]), t.started = !0)
            //        }), c(document.body).on("change", ".mc4wp-form", function (e) {
            //            var t = a.getByElement(e.target || e.srcElement);
            //            a.trigger("change", [t, e])
            //        }), f.submitted_form) {
            //        var d = f.submitted_form, m = document.getElementById(d.element_id), p = a.getByElement(m);
            //        i(p, d.action, d.errors, d.data)
            //    }
            //    s.forms = a, window.mc4wp = s
            //}
        }, {"./forms/forms.js": 3, gator: 5}], 2: [function (e, t, n) {
            "use strict";
            var r = e("form-serialize"), i = e("populate.html"), o = function (e, t) {
        ...
        }, {"form-serialize": 4, "populate.js": 6}], 3: [function (e, t, n) {
            "use strict";
            function r(e) {
                for (var t = 0; t < d.length; t++)if (d[t].id == e)return d[t];
                var n = document.querySelector(".mc4wp-form-" + e);
                return o(n, e)
            }

            function i(e) {
                for (var t = e.form || e, n = 0; n < d.length; n++)if (d[n].element == t)return d[n];
                return o(t)
            }
            ...
            var f = e("wolfy87-eventemitter"), l = e("form.html"), h = new f, d = [];
            t.exports = {all: s, get: r, getByElement: i, on: c, trigger: a, off: u}
        }, {"./form.js": 2, "wolfy87-eventemitter": 7}], 4: [function (e, t, n) {
            function r(e, t) {
                ...
                for (var n = t.hash ? {} : "", r = t.serializer || (t.hash ? s : c), i = e && e.elements ? e.elements : [], o = Object.create(null), f = 0; f < i.length; ++f) {
                    ...
                    if ((t.disabled || !l.disabled) && l.name && u.test(l.nodeName) && !a.test(l.type)) {
                        ...
                        if ("select-multiple" !== l.type)n = r(n, h, d); else {
                            d = [];
                            for (var m = l.options, p = !1, v = 0; v < m.length; ++v) {
                                var g = m[v], y = t.empty && !g.value, w = g.value || y;
            ...
            function i(e) {
                var t = [], n = /^([^\[\]]*)/, r = new RegExp(f), i = n.exec(e);
            ...
            function s(e, t, n) {
                ...
                if (r) {
                    ...
                    var c = e[t];
                    c ? (Array.isArray(c) || (e[t] = [c]), e[t].push(n)) : e[t] = n
                }
                return e
            }
            ...
            var a = /^(?:submit|button|image|reset|file)$/i, u = /^(?:input|select|textarea|keygen)/i, f = /(\[[^\[\]]*\])/g;
            t.exports = r
        }, {}], 5: [function (e, t, n) {
            !function () {
                function e(e, t, n) {
                ...
                function s(e, t, n, r) {
                    if (d[e.id])if (t) {
                        ...
                        if (d[e.id][t][n])for (var i = 0; i < d[e.id][t][n].length; i++)if (d[e.id][t][n][i] === r) {
                            d[e.id][t][n].splice(i, 1);
                            break
                        }
                    } else for (var o in d[e.id])d[e.id].hasOwnProperty(o) && (d[e.id][o] = {})
                }

                function c(e, t, n) {
                    if (d[e][n]) {
                        var r, o, s = t.target || t.srcElement, c = {}, a = 0, f = 0;
                        l = 0;
                        for (r in d[e][n])d[e][n].hasOwnProperty(r) && (o = i(s, r, m[e].element), o && u.matchesEvent(n, m[e].element, o, "_root" == r, t) && (l++, d[e][n][r].match = o, c[l] = d[e][n][r]));
                        for (t.stopPropagation = function () {
                            t.cancelBubble = !0
                        }, a = 0; a <= l; a++)if (c[a])for (f = 0; f < c[a].length; f++) {
                ...
                function a(e, t, n, r) {
                    ...
                    if (this.element) {
                        ...
                        var a, f = this.id;
                        for (a = 0; a < e.length; a++)r ? s(this, e[a], t, n) : (d[f] && d[f][e[a]] || u.addEvent(this, e[a], i(e[a])), o(this, e[a], t, n));
                        return this
                    }
                }
                ...
                }, u.matchesSelector = function () {
                }, u.cancel = n, u.addEvent = e, u.matchesEvent = function () {
                    return !0
            ...
            !function (e) {
                var r = function (e, t, n) {
                    for (var i in t)if (t.hasOwnProperty(i)) {
                        var o = i, s = t[i];
                        if ("undefined" != typeof n && (o = n + "[" + i + "]"), s.constructor === Array)o += "[]"; else if ("object" == typeof s) {
                            r(e, s, o);
                            continue
                        }
            ...
            (function () {
                ...
                var o = e.prototype, s = this, c = s.EventEmitter;
                o.getListeners = function (e) {
                    ...
                    for (n in i)i.hasOwnProperty(n) && r(i[n], t) === -1 && i[n].push(o ? t : {listener: t, once: !1});
                    return this
                    ...
                    var n, r, i, o, s, c = this.getListenersAsObject(e);
                    for (o in c)if (c.hasOwnProperty(o))for (n = c[o].slice(0), i = n.length; i--;)r = n[i], r.once === !0 && this.removeListener(e, r.listener), s = r.listener.apply(this, t || []), s === this._getOnceReturnValue() && this.removeListener(e, r.listener);
                    return this
