...
<div class="kc-elm kc-css-696688 kc_row " style="margin-bottom: 20px">
    <div class="mySlides" >
        <div class="ms-slide-bgcont">
            <img src="{SITE-NAME}/view/default/themes/images/res1_slide2.jpg"
            ...
            <div class="ms-slide-layers">
                <div class="ms-anim-layers">
                    <img class="ms-layer ms-hover-active slide_img_1"
                         src="{SITE-NAME}/view/default/themes/images/slide_icon_3.png" alt="" >

                    <div class="ms-layer  msp-cn-2-8 ms-hover-active slide_div_2">
                        The Place Perfect To Eat
                    </div>
                    <p class="hidden-sm "><br></p>
                    <img class="ms-layer ms-hover-active slide_img_2"  src="http://new2new.com/echion/wp-content/uploads/2016/07/slide_icon_4.png" alt="">
                    <p class="hidden-sm slide_hidden"><br></p>
    ...
    <div  class="mySlides">
        <div class="ms-slide-bgcont">
            <img src="{SITE-NAME}/view/default/themes/images/res1_slide1.jpg"
                 alt="" title="res1_slide1"
            >
        </div>
        <div class="ms-scroll-parallax-cont slide_div_1">
