    ...
    <div class="content-inner">
        <div class="entry-content">
            ...
            <div style="font-size: 14px" class="article-date"><i class="fa fa-calculator"></i> <span style="font-style: italic;">{created}</span> | <span class="comments-link">
                        <a href="{link}" style="font-style: italic;"> <i class="fa fa-eye"></i> {view}</a></span> | <span class="byline" style="font-style: italic;">Danh mục: <a class="url fn n"
                                                                                                                          href="{link_danhmuc}"> {name_danhmuc}</a></span>
            </div>
            <!-- .entry-header -->
                        ...
                        <ul class="woo_share_social">
                            ...
                            <li>
                                <a class="googleplus" target="_blank" title="Chia sẻ qua email"
                                   href="mailto:?Subject={name}?&amp;body={name}:{content}"
