...
<head>
    ...
    <style type="text/css" id="kc-css-render">@media only screen and (min-width: 1000px) and (max-width: 5000px) {
        ...
        body.kc-css-system .kc-css-463651 {
            background: transparent url({SITE-NAME}/view/default/themes/wp-content/uploads/2016/07/bg-our-menu.jpg) 0% 0%/auto repeat fixed;
            padding-top: 80px;
        }
    ...
    <link rel='stylesheet'
          href='{SITE-NAME}/view/default/themes/css/style.css' type='text/css' media='all'/>
</head>
<div id="fb-root"></div>
